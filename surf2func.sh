...
# 查看一下在anat的皮层是否正确
GreyMatterMask_dir=/gpfs/milgram/project/turk-browne/projects/rtTest/subjects/${subject}/GreyMatterMask/
# cd ${GreyMatterMask_dir}
anat_reorien=/gpfs/milgram/project/turk-browne/projects/rtTest/subjects/${subject}/anat/anat_reorien.nii.gz
